...
import org.json.utils.xmlutils.XmlFileException;
import org.w3c.dom.*;
...
/**
 * Utility class for performing file and data operations on XML files.
...
public class XmlFileUtils {
    ...
    /**
     * Creates a new XML file with the given root element name.
     */
    ...
    /**
     * Reads an XML file into a Document object.
     */
    ...
    /**
     * Writes a Document object to an XML file (overwrites).
     */
    ...
    /**
     * Updates an XML file by applying a transformation to the Document.
     */
    ...
    /**
     * Searches for elements by tag name (top-level only).
     */
    ...
    /**
     * Gets the value of an element by tag name (first occurrence).
     */
    ...
    /**
     * Pretty prints the XML file (well-formatted output).
     */
    ...
    /**
     * Validates if the XML file is not empty and is well-formed.
     */
    ...
    /**
     * Deletes elements matching a predicate (by tag name, top-level only).
     */
